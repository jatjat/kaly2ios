...
extension Ca_Joelathiessen_Kaly2_Proto_RobotServiceClientProtocol {
  ...
  internal func createRobot(
    ...
    return self.makeUnaryCall(
      path: Ca_Joelathiessen_Kaly2_Proto_RobotServiceClientMetadata.Methods.createRobot.path,
      request: request,
...
extension Ca_Joelathiessen_Kaly2_Proto_RobotServiceAsyncClientProtocol {
  internal static var serviceDescriptor: GRPCServiceDescriptor {
    return Ca_Joelathiessen_Kaly2_Proto_RobotServiceClientMetadata.serviceDescriptor
  }
...
internal enum Ca_Joelathiessen_Kaly2_Proto_RobotServiceClientMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "RobotService",
    fullName: "ca.joelathiessen.kaly2.proto.RobotService",
    methods: [
      Ca_Joelathiessen_Kaly2_Proto_RobotServiceClientMetadata.Methods.createRobot,
    ]
  )

  internal enum Methods {
    internal static let createRobot = GRPCMethodDescriptor(
      name: "CreateRobot",
...
extension Ca_Joelathiessen_Kaly2_Proto_RobotServiceProvider {
  internal var serviceName: Substring {
    return Ca_Joelathiessen_Kaly2_Proto_RobotServiceServerMetadata.serviceDescriptor.fullName[...]
  }
...
internal enum Ca_Joelathiessen_Kaly2_Proto_RobotServiceServerMetadata {
  internal static let serviceDescriptor = GRPCServiceDescriptor(
    name: "RobotService",
    fullName: "ca.joelathiessen.kaly2.proto.RobotService",
    methods: [
      Ca_Joelathiessen_Kaly2_Proto_RobotServiceServerMetadata.Methods.createRobot,
    ]
  )
