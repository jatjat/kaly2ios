...
PROTOS_DIR=Shared/logic/Infrastructure/Protos
GENERATED_MODELS_DIR=Shared/logic/Infrastructure/Generated/Models
GENERATED_GRPC_BINDINGS_DIR=Shared/logic/Infrastructure/Generated/GRPC
